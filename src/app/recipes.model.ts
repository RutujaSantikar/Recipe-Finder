...
//   ],
//      instructions:[
//    "In a pan heat oil and add garlic. Saute till it gives a nice aroma. Add the onions and saute till soft."
// ,
    
//     "Add the tomatoes, chilli flakes, and oregano seasoning and cook till tomatoes are soft."
// ,

//     "Cool and grind to a paste."
//     ,
     
//     "Add the tomato ketchup to this paste and mix well."
//     ,
   
//     "Take a pizza base and spread the sauce on the base."
//     ,
   
// "Put the pizza toppings of corn and capsicum. Grate cheese on top."
    
//     ,
    
//        "Heat a flat bottomed pan or tava and put 1 tbs of butter. When butter melts place the prepared pizza on it and cover with a lid."
    
//     ,
    
//     "Heat on slow flame till cheese melts and base turns a little crisp."
...
//     'Add the tomato ketchup to this paste and mix well.',
//     'Take a pizza base and spread the sauce on the base.',
//     'Put the pizza toppings of corn and capsicum and paneer. Grate cheese on top.'   ,
//     'Heat a flat bottomed pan or tava and put 1 tbs of butter. When butter melts place the prepared pizza on it and cover with a lid.',
//     'Heat on slow flame till cheese melts and base turns a little crisp.',
//     ]
//     },
...
//       'Take the boiled rajma, potatoes, peas and small bread pieces. Combine this with masalas and mix.'
//     ,
// 'Give it the shape of Tikki and dip the Tikki in cornflour slurry and bread crumbs. Pan fry this till golden brown.'
//     ,
    
//    'Then take the buns and lightly toast them with butter on a pan. Take it out and assemble your burger'
//     ,
     
//     'Now first, add a layer of tomato ketchup on one side of the burger, then place the patty, cheese, sliced onion and tomato.'
//     ,
   
//      'From the top, add sauces like mustard sauce, mayonnaise, or any other sauce of your choice.'
//     ,
   
//       'Finally, close the bun, serve it with fries and enjoy!.'
...
//    'Mix the potatoes with the corn, onion, leeks, celery.'
//    ,
   
//    'Add the jalapenos, a large handful of coriander and crumble the feta cheese into the mixture.'
//    ,
   
//    'Mix all the ingredients really well and season to taste.'
//    ,
   
//     'Put the bread crumbs in a plate,Shape the burger patties into with a cutter or mould.'
    
//     ,
    
//     'Dip the patty in the batter and cover with breadcrumbs,Heat up 2 tbsp oil in pan and shallow fry until nice and brown.'
    
//     ,
    
//     'Slice up some tomatoes and put it in a lettuce leaf for the garnish along with some gherkins.'
    
//     ,
    
//     'Heat the buns in the oven.'
    
//     ,
    
//     'Put the lettuce, tomatoes and gherkins inside the bun along with the patty and serve with chips on the side.'
...
//   ],
//      instructions:[
//       'In a large mixing bowl add the onions, capsicum, tomatoes, green chillies, coriander leaves, boiled and mashed potato, salt, chaat masala and black pepper powder and mix well.'
//    ,
